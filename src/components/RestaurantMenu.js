...
import { addCart } from "../utils/createSlice";
...
const RestaurantMenu = () => {
  ...
  return (
    <div className="w-3/4 bg-gray-200 mx-auto mt-3.5" >
      ...
      }}  className="flex justify-between p-2.5 bg-gray-300 cursor-pointer" >
    ...
    {show &&  ResMenu.map((item) => {
        ...
        return (
          <div key={id} className="border-b-2 border-gray-300 p-2.5 mt-0.5 flex justify-between" onClick={()=>dispatch(addCart(item))}>
<div className="">
